-- DnD 5e PT-BR — schema + RLS (idempotente: pode rodar de novo)
...
alter table public.characters drop constraint if exists characters_level_positive;
...
-- Remove policies antigas com segurança (tabelas já existem acima)
do $$
begin
